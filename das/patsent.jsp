...
<%      
	...
	try{
		String url="jdbc:mysql://localhost:3306/project";
			...
			ResultSet rs;
			rs=stmt.executeQuery("select * FROM docinbox,patient_reg where docinbox.name=patient_reg.username");//functionality
  ...
  out.println("<tr><td>S No.</td><td>name &nbsp;</td><td>Subject</td><td>Mail</td><td>Attachment &nbsp;</td><td>Date</td></tr>");
			...
			{    
				 ...
				 out.println("<tr><td><input type=text name=t1 value='"+no+"'></td><td><input type=text name=t2 value='"+name+"'></td><td><INPUT TYPE=TEXT NAME=t3 VALUE='"+subject+"'></td><td><input type=text name=t4 value='"+mail+"'></td><td><input type=text name=t5 value='"+attachment+"'></td>");
				 no=no+1;
